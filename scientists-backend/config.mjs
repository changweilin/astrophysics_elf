...
export const config = {
  ...
  wiki: {
    ...
    // Retrieval asks the offline wiki-kb corpus first (../wiki-kb, same
    // process -- see knowledge/wiki.mjs) and only falls back to live
    // Wikipedia if the KB has nothing for the query.
